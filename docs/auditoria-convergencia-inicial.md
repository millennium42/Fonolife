...
| CV-005 | P1 | Proteção | Proteção da `main` não foi comprovada; `gh` não estava disponível no host | consulta local `rtk gh api ...` | Consultar/configurar com credencial administrativa e registrar resposta exata | 16 |
