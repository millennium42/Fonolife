...
| CV-008 | P1 | Produto | Corrigido: 71 requisitos rastreados e cinco jornadas E2E cobrem operador, Caixa, médico, administrador e LGPD | `docs/original-plan-acceptance.md`, `tests/e2e/original-plan-journeys.spec.ts` | Resolvido | 19 |
