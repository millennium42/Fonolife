...
## Corpus Check
- Corpus is ~25.653 words - fits in a single context window. You may not need a graph.

## Summary
- 170 nodes · 325 edges · 10 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 128 · imports: 46 · MODIFIES: 43 · imports_from: 25 · reads_from: 20 · ON_BRANCH: 18 · references: 17 · calls: 10 · triggers: 10 · PARENT_OF: 8


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 55 · Candidates: 66
- Excluded: 50 untracked · 6220 ignored · 0 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `4de92ce`
...
## Knowledge Gaps
- **28 isolated node(s):** `company_accounts`, `User`, `FastifyRequest`, `attempts`, `email` (+23 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `hashPassword()` connect `Community 2` to `Community 4`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `pool` connect `Community 2` to `Community 4`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `verifyPassword()` connect `Community 2` to `Community 4`?**
