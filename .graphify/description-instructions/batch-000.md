...
- "src_app": "app.ts" | kind=code-symbol | source=src/app.ts:L1 | neighbors=[0d2db0f feat: centralizar cadastro e hi…, 0e1c4ad test: consolidar QA, acessibili…, 2dd873d feat: consolidar financeiro úni…, 3f9e6cc feat: estabelecer núcleo seguro…, 98e15b2 feat: implementar importação CS…, a56a353 feat: priorizar filas acionávei…] | lang=en
...
- "domain_patients": "patients.ts" | kind=code-symbol | source=src/domain/patients.ts:L1 | neighbors=[0d2db0f feat: centralizar cadastro e hi…, csv-import.ts, CONTACT_SOURCES, ContactSource, isOneOf(), normalizePhone()] | lang=en
...
- "domain_sales": "sales.ts" | kind=code-symbol | source=src/domain/sales.ts:L1 | neighbors=[a740db5 feat: registrar vendas com parc…, csv-import.ts, finance.ts, DELIVERY_STATUSES, PAYMENT_METHODS, SaleInstallment] | lang=en
...
- "branch:repo:github.com/millennium42/Fonolife#codex/pr8-importacao-csv-seguranca": "codex/pr8-importacao-csv-seguranca" | kind=Branch | source=git | neighbors=[0d2db0f feat: centralizar cadastro e hi…, 0e1c4ad test: consolidar QA, acessibili…, 2dd873d feat: consolidar financeiro úni…, 3f9e6cc feat: estabelecer núcleo seguro…, 4de92ce Graphify, 68c033b chore: inicializar main para en…] | lang=en
...
- "db_seed": "seed.ts" | kind=code-symbol | source=src/db/seed.ts:L1 | neighbors=[3f9e6cc feat: estabelecer núcleo seguro…, pool.ts, pool, seedDemo(), security.ts, hashPassword()] | lang=en
- "src_server": "server.ts" | kind=code-symbol | source=src/server.ts:L1 | neighbors=[3f9e6cc feat: estabelecer núcleo seguro…, migrate.ts, migrate(), seed.ts, seedDemo(), app.ts] | lang=en
...
- "db_pool": "pool.ts" | kind=code-symbol | source=src/db/pool.ts:L1 | neighbors=[3f9e6cc feat: estabelecer núcleo seguro…, create-admin.ts, migrate.ts, pool, config.ts, config] | lang=en
...
- "commit:repo:github.com/millennium42/Fonolife@98e15b232d3362549543120d010f27f51e2970dc": "98e15b2 feat: implementar importação CSV idempotente com auditoria e controle d…" | kind=Commit | source=git | neighbors=[4de92ce Graphify, codex/pr8-importacao-csv-seguranca, csv-import.ts, 006_csv_imports.sql, app.ts, main.tsx] | lang=pt
...
- "domain_patients_normalizephone": "normalizePhone()" | kind=code-symbol | source=src/domain/patients.ts:L10 | neighbors=[csv-import.ts, patients.ts, validPatientPhone(), app.ts, patients.test.ts] | lang=en
