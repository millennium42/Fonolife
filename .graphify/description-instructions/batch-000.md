...
- "domain_patients": "patients.ts" | kind=code-symbol | source=src/domain/patients.ts:L1 | neighbors=[0d2db0f feat: centralizar cadastro e hi…, CONTACT_SOURCES, ContactSource, isOneOf(), normalizePhone(), PATIENT_EVENT_TYPES] | lang=en
...
- "domain_sales": "sales.ts" | kind=code-symbol | source=src/domain/sales.ts:L1 | neighbors=[a740db5 feat: registrar vendas com parc…, finance.ts, DELIVERY_STATUSES, PAYMENT_METHODS, SaleInstallment, splitMonthly()] | lang=en
...
- "domain_finance": "finance.ts" | kind=code-symbol | source=src/domain/finance.ts:L1 | neighbors=[2dd873d feat: consolidar financeiro úni…, ENTRY_TYPES, FINANCE_CATEGORIES, validFinancialEntry(), sales.ts, PAYMENT_METHODS] | lang=en
...
- "domain_patients_normalizephone": "normalizePhone()" | kind=code-symbol | source=src/domain/patients.ts:L10 | neighbors=[patients.ts, validPatientPhone(), app.ts, patients.test.ts] | lang=en
