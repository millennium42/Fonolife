...
- "commit:repo:github.com/millennium42/Fonolife@2f9877e1fd38dddc18cf9fc40e6cb20e97aff5e3": "2f9877e test(attachments): cobrir fronteiras de ambiente e quarentena" | kind=Commit | source=git | neighbors=[codex/pr-06-attachments-production-boun…, bd7294b refactor(attachments): separar …, attachment-environment-boundary.test.ts, 39dd6c8 chore(graphify): atualizar mapa…] | lang=nl
- "commit:repo:github.com/millennium42/Fonolife@a25d7b658825b0f8b29e6cccee202136a330170f": "a25d7b6 feat(attachments): integrar scanner configurável" | kind=Commit | source=git | neighbors=[codex/pr-06-attachments-production-boun…, e460e7a fix(attachments): endurecer sto…, attachments.ts, bd7294b refactor(attachments): separar …] | lang=pt
- "commit:repo:github.com/millennium42/Fonolife@bd7294bae8e2d08905a3f4672f70868274d162df": "bd7294b refactor(attachments): separar providers e configuração" | kind=Commit | source=git | neighbors=[2f9877e test(attachments): cobrir front…, codex/pr-06-attachments-production-boun…, a25d7b6 feat(attachments): integrar sca…, config.ts] | lang=pt
- "commit:repo:github.com/millennium42/Fonolife@e460e7af1763ce0dea5c10623bfe570fb25d2ecc": "e460e7a fix(attachments): endurecer storage S3 e download" | kind=Commit | source=git | neighbors=[a25d7b6 feat(attachments): integrar sca…, codex/pr-06-attachments-production-boun…, e79f008 docs(attachments): documentar d…, app.ts] | lang=pt
...
- "domain_attachments_detectmimetypefrommagicbytes": "detectMimeTypeFromMagicBytes()" | kind=code-symbol | source=src/domain/attachments.ts:L410 | neighbors=[attachments.ts, .scan(), attachments.test.ts, secure-attachments.test.ts] | lang=en
- "domain_attachments_reconcileorphanattachments": "reconcileOrphanAttachments()" | kind=code-symbol | source=src/domain/attachments.ts:L466 | neighbors=[attachments.ts, .listKeys(), app.ts, secure-attachments.test.ts] | lang=en
- "domain_attachments_sanitizefilename": "sanitizeFilename()" | kind=code-symbol | source=src/domain/attachments.ts:L377 | neighbors=[attachments.ts, app.ts, attachments.test.ts, secure-attachments.test.ts] | lang=en
...
- "domain_attachments_generatestoragekey": "generateStorageKey()" | kind=code-symbol | source=src/domain/attachments.ts:L456 | neighbors=[attachments.ts, app.ts, secure-attachments.test.ts] | lang=en
