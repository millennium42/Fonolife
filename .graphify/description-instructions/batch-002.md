...
- "commit:repo:github.com/millennium42/Fonolife@483b27dfc281f2720b927feedda3c8662affa771": "483b27d feat(attachments): implementar upload streaming e estados" | kind=Commit | source=git | neighbors=[codex/pr-05-auth-csrf-hardening, main, dbdb5db docs(attachments): registrar re…, 015_secure_attachments.sql, app.ts, c45b42d refactor(attachments): introduz…] | lang=en
- "commit:repo:github.com/millennium42/Fonolife@55ec728c86a65b09b08ef7ee58766647236df5c1": "55ec728 Merge branch 'main' of https://github.com/millennium42/Fonolife" | kind=Commit | source=git | neighbors=[1091aa4 feat(core): implementa melhoria…, codex/pr-05-auth-csrf-hardening, main, 0b8c651 fix(csrf): endurecer validacao …, 7139d08 docs: adicionar guia de desenvo…, codex/pr-01-security-object-lgpd] | lang=en
- "commit:repo:github.com/millennium42/Fonolife@c45b42d5443f93e69b1c55c4870b8af1604bdae9": "c45b42d refactor(attachments): introduzir contrato de armazenamento privado" | kind=Commit | source=git | neighbors=[codex/pr-05-auth-csrf-hardening, main, 483b27d feat(attachments): implementar …, attachments.ts, config.ts, d183f47 test(attachments): reproduzir s…] | lang=nl
...
- "commit:repo:github.com/millennium42/Fonolife@1524f7fd80a19fc35988f2d5a627da3d1584cff4": "1524f7f test(auth): cobrir limite distribuído e revogação de sessões" | kind=Commit | source=git | neighbors=[codex/pr-05-auth-csrf-hardening, main, 20d3779 refactor(auth): registrar módul…, auth-session.test.ts, c8ba103 chore(graphify): atualizar graf…, codex/pr-03-auth-session-reliability] | lang=pt
- "commit:repo:github.com/millennium42/Fonolife@2945f8e18c7f05ef1da130426f7e39af906b2e3f": "2945f8e refactor(import): adotar parser mantido e streaming" | kind=Commit | source=git | neighbors=[codex/pr-05-auth-csrf-hardening, main, 4b82016 fix(import): versionar hash e i…, csv-import.ts, csv-import.test.ts, c1ef4e2 test(import): adicionar fixture…] | lang=en
- "commit:repo:github.com/millennium42/Fonolife@80a24830f836473c8188bfcbd3ce41faf7fc5a94": "80a2483 feat(admin): criar bootstrap seguro do primeiro administrador" | kind=Commit | source=git | neighbors=[2600ae3 feat(auth): persistir tentativa…, codex/pr-05-auth-csrf-hardening, main, 733ff41 docs(auth): documentar sessão, …, bootstrap-admin.ts, codex/pr-03-auth-session-reliability] | lang=pt
- "commit:repo:github.com/millennium42/Fonolife@c8ba10330da1341fb82ea2321fcf01997869e8b6": "c8ba103 chore(graphify): atualizar grafo de conhecimento apos refatoracao de an…" | kind=Commit | source=git | neighbors=[codex/pr-05-auth-csrf-hardening, main, 1524f7f test(auth): cobrir limite distr…, dbdb5db docs(attachments): registrar re…, codex/pr-02-secure-attachments, codex/pr-03-auth-session-reliability] | lang=nl
- "commit:repo:github.com/millennium42/Fonolife@dbdb5db8afbff87aa8880faf631b12dbad70b965": "dbdb5db docs(attachments): registrar retenção, storage e rollback" | kind=Commit | source=git | neighbors=[483b27d feat(attachments): implementar …, codex/pr-05-auth-csrf-hardening, main, c8ba103 chore(graphify): atualizar graf…, codex/pr-02-secure-attachments, codex/pr-03-auth-session-reliability] | lang=pt
