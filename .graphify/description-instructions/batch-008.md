...
- "src_app_fastifyrequest": "FastifyRequest" | kind=code-symbol | source=src/app.ts:L80 | neighbors=[app.ts]
- "src_app_user": "User" | kind=code-symbol | source=src/app.ts:L70 | neighbors=[app.ts]
