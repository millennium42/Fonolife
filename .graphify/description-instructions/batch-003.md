...
- "src_app_buildapp": "buildApp()" | kind=code-symbol | source=src/app.ts:L56 | neighbors=[app.ts, server.ts]
...
- "src_main_app": "App()" | kind=code-symbol | source=web/src/main.tsx:L1825 | neighbors=[main.tsx]
...
- "src_main_csvimport": "CsvImport()" | kind=code-symbol | source=web/src/main.tsx:L1703 | neighbors=[main.tsx]
