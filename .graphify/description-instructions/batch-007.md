...
- "src_app_fastifyrequest": "FastifyRequest" | kind=code-symbol | source=src/app.ts:L77 | neighbors=[app.ts]
- "src_app_user": "User" | kind=code-symbol | source=src/app.ts:L67 | neighbors=[app.ts]
