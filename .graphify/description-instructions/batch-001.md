...
- "domain_attachments": "attachments.ts" | kind=code-symbol | source=src/domain/attachments.ts:L1 | neighbors=[a7b6a8a feat(attachments): adicionar va…, e517fa0 refactor(core): implementa corr…, ALLOWED_MIME_TYPES, AllowedMimeType, calculateFileHash(), detectMimeTypeFromMagicBytes()] | lang=en
