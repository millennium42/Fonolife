...
Community 2: codex/01-servicos-catalogo-estoque, codex/02-medico-responsavel-prontuario-global, codex/03-caixa-pdv-relatorio-financeiro, codex/04-design-system-seed-demo, codex/pr8-importacao-csv-seguranca, main, 0687af4 feat(privacy): implementar endpoints de exportação J, 077b08e feat(privacy): adicionar migration 010 para pseudoni, 0d2db0f feat: centralizar cadastro e histórico de pacientes , 0e1c4ad test: consolidar QA, acessibilidade e release do Fon, 2dd873d feat: consolidar financeiro único para dois CNPJs (#, 3a29c99 chore(deploy): preparar infraestrutura no Render com [lang=pt]
Community 3: validProduct(, 264533a feat(services): adicionar migracao, modelo de domini, 5fe1e04 feat(doctor): adicionar perfil médico, agenda calend, d7896dd Merge branch 'codex/01-servicos-catalogo-estoque' in, inventory.ts, InventoryMovement, MOVEMENT_TYPES, MovementType, Product, validInventoryMovement(, validNonNegativeCents(, validProductBrand( [lang=nl]
...
Community 7: 53e373d Merge branch 'codex/04-design-system-seed-demo' into, 864030b feat(frontend): implementar Caixa PDV, prontuario gl, 91c499c Merge branch 'codex/02-medico-responsavel-prontuario, 9bcad1d feat(seed): povoar banco de dados com informacoes re, 9cabae8 Merge branch 'codex/03-caixa-pdv-relatorio-financeir, b0009ad feat(patients): adicionar medico responsavel ao paci, doctors.ts, buildCalendarDays(, CalendarDay, validLicenseNumber(, validDoctorId(, 013_responsible_doctor.sql [lang=en]
