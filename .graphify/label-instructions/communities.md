...
Community 0: normalizePhone(, validPatientPhone(, 0d2db0f feat: centralizar cadastro e histórico de pacientes , a740db5 feat: registrar vendas com parcelas e pós-venda auto, csv-import.ts, calculateCsvHash(, CsvFinancialRow, CsvPatientRow, parseCsv(, ParsedCsv, sanitizeCsvCell(, validateFinancialCsvRow( [lang=pt]
...
Community 2: codex/pr8-importacao-csv-seguranca, main, 0687af4 feat(privacy): implementar endpoints de exportação J, 077b08e feat(privacy): adicionar migration 010 para pseudoni, 0e1c4ad test: consolidar QA, acessibilidade e release do Fon, 2dd873d feat: consolidar financeiro único para dois CNPJs (#, 4de92ce Graphify, 5ccde91 feat: implementar atalhos rápidos de comunicação via, 639a914 feat(privacy): adicionar botão de portabilidade e an, 68c033b chore: inicializar main para entregas independentes, 7fdb702 feat(attachments): adicionar seção de exames na fich, 98e15b2 feat: implementar importação CSV idempotente com aud [lang=pt]
...
Community 6: validProduct(, inventory.ts, InventoryMovement, MOVEMENT_TYPES, MovementType, Product, validInventoryMovement(, validProductBrand(, validProductModel(, validProductName(, inventory.test.ts [lang=en]
Community 7: attachments.ts, ALLOWED_MIME_TYPES, AllowedMimeType, calculateFileHash(, sanitizeFilename(, validFileSize(, validMimeType(, attachments.test.ts [lang=en]
