...
Community 1: main.tsx, api(, App(, categoryLabels, cents(, CompanyAccount, CsvImport(, Dashboard(, DashboardData, date(, DoctorCalendar(, DoctorConsultationForm( [lang=en]
Community 2: codex/01-servicos-catalogo-estoque, codex/pr8-importacao-csv-seguranca, main, 0687af4 feat(privacy): implementar endpoints de exportação J, 077b08e feat(privacy): adicionar migration 010 para pseudoni, 0e1c4ad test: consolidar QA, acessibilidade e release do Fon, 2dd873d feat: consolidar financeiro único para dois CNPJs (#, 3a29c99 chore(deploy): preparar infraestrutura no Render com, 4de92ce Graphify, 557b254 fix(deploy): corrigir render.yaml para sintaxe válid, 5ccde91 feat: implementar atalhos rápidos de comunicação via, 639a914 feat(privacy): adicionar botão de portabilidade e an [lang=pt]
...
Community 4: pool, hashPassword(, 3f9e6cc feat: estabelecer núcleo seguro e executável da clín, create-admin.ts, email, migrate.ts, migrate(, pool.ts, seed.ts, seedDemo(, security.ts, hashToken( [lang=pt]
Community 5: restrict_follow_up_update(, 003_follow_up_tasks.sql, follow_up_tasks, follow_up_tasks_no_delete, follow_up_tasks_restrict_update, OLD.created_at, OLD.created_by, OLD.due_on, OLD.notes, OLD.patient_id, OLD.title, patients [lang=en]
Community 6: validProduct(, inventory.ts, InventoryMovement, MOVEMENT_TYPES, MovementType, Product, validInventoryMovement(, validNonNegativeCents(, validProductBrand(, validProductModel(, validProductName(, inventory.test.ts [lang=en]
...
Community 8: 5fe1e04 feat(doctor): adicionar perfil médico, agenda calend, doctors.ts, buildCalendarDays(, CalendarDay, validLicenseNumber(, 011_doctor_schedule.sql, doctors.test.ts [lang=en]
...
Community 14: follow-ups.ts, FOLLOW_UP_FILTERS, saoPauloDate(, follow-ups.test.ts [lang=en]
